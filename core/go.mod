...
require (
	...
	github.com/jolatechno/ipfs-mpi/core/ipfs-interface v0.0.0-20200323223939-6e810f394563
	github.com/jolatechno/ipfs-mpi/core/mpi-interface v0.0.0-20200323224012-1277145ab164 // indirect
